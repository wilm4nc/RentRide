...
public sealed record GetVehiculosByPaginationQueryHandler
: IQueryHandler<GetVehiculosByPaginationQuery, PaginationResult<Vehiculo, VehiculoId>>
{
    ...
    {
       var spec = new VehiculoPaginacionSpecification(
         request.Sort!,
         request.PageIndex,
         request.PageSize,
         request.Modelo! 
    ...
    var specCount =new VehiculoPaginacionCountingSpecification(request.Modelo!);
